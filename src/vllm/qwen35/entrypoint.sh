...
TMUX_CONF_URL=${TMUX_CONF_URL:-https://raw.githubusercontent.com/rthomazel/interface/dev/vps/dotfiles/.tmux.conf}
...
VLLM_BASE_URL=${VLLM_BASE_URL:-http://127.0.0.1}
VLLM_PORT=${VLLM_PORT:-8000}
BENCH_NUM_PROMPTS=${BENCH_NUM_PROMPTS:-8}
BENCH_RANDOM_INPUT=${BENCH_RANDOM_INPUT:-50000}
BENCH_RANDOM_OUTPUT=${BENCH_RANDOM_OUTPUT:-4000}
